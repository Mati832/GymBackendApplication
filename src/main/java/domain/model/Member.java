...
public class Member extends User {
    ...
    public Member(Long id, String firstName, String lastName, String email, String password,
                  Gender gender, LocalDateTime bornOn, LocalDateTime createdAt, List<Long> coaches) {
        super(id, firstName, lastName, email, password, gender, bornOn, createdAt);
        this.coaches = coaches;
    }

    public Member(String firstName, String lastName, String email, String password, Gender gender, LocalDateTime bornOn){
